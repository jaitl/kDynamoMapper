...
import com.github.jaitl.dynamodb.mapper.helper.SimpleDataAdt
import com.github.jaitl.dynamodb.mapper.helper.SimpleAdt
...
internal class AdtTest {
    ...
    fun testWriteSimpleAdt() {
        ...
        val adtMap = mapOf(
            ...
            "adt_class_name" to stringAttribute("com.github.jaitl.dynamodb.mapper.helper.SimpleAdt\$AdtOne")
        )
    ...
    fun testReadAdtBySealedClass() {
        val adtMap = mapOf(
            ...
            "adt_class_name" to stringAttribute("com.github.jaitl.dynamodb.mapper.helper.SimpleAdt\$AdtTwo")
        )
    ...
    fun testWriteAdtBySealedClassInherited() {
        ...
        val expectedData = mapOf(
            ...
            "adt_class_name" to stringAttribute("com.github.jaitl.dynamodb.mapper.helper.SimpleAdt\$SecondSimpleAdt\$AdtSecondOne")
        )
    ...
    fun testReadAdtBySealedClassWrongClass() {
        val adtMap = mapOf(
            "long" to numberAttribute(1234),
            "adt_class_name" to stringAttribute("com.github.jaitl.dynamodb.mapper.helper.SimpleDataAdt")
        )
    ...
    fun testReadNotExistsClass() {
        val adtMap = mapOf(
            "string" to stringAttribute("test"),
            "adt_class_name" to stringAttribute("com.github.jaitl.dynamodb.mapper.helper.Adt")
        )
        val obj = mapOf(
            "adt" to mapAttribute(adtMap),
        )
